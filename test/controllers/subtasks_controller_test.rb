...
class SubtasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subtask" do
    assert_difference('Subtask.count') do
      post subtasks_url, params: { subtask: { item: @subtask.item, task: @subtask.task, todo_item_id: @subtask.todo_item_id } }
    end
  ...
  test "should update subtask" do
    patch subtask_url(@subtask), params: { subtask: { item: @subtask.item, task: @subtask.task, todo_item_id: @subtask.todo_item_id } }
